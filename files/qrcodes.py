...
def qrCodeMatrix(data):
    ...
    and return it as a numpy array of `0` and `1`s.
    """

    qr = qrcode.QRCode(
        version=2,  # None: automatically determine size.  1~40
        error_correction=qrcode.constants.ERROR_CORRECT_L,  # 7% error tolerance,, L/M/
